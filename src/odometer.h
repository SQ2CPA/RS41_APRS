...
// #define EEPROM_TOTAL_DISTANCE_ADDRESS 0
// #define EEPROM_GPS_DATA_ADDRESS 4
// #define EEPROM_FIRST_RUN_FLAG_ADDRESS 12
// #define EEPROM_LAST_DISTANCE_LOGGED_ADDRESS 13
